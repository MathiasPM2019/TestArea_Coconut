...
namespace TestAreaCoconut\Providers;
...
/**
 * Class TestAreaCoconutServiceProvider
 * @package TestAreaCoconut\Providers
 */
class TestAreaCoconutServiceProvider extends ServiceProvider
{
    const PRIORITY = 0;
    ...
    {
        $enabledOverrides = explode(", ", $config->get("TestAreaCoconut.templates.override"));
        ...
        $dispatcher->listen('IO.init.templates', function (Partial $partial) use ($enabledOverrides)
        {
            ...
            {
                $partial->set('head', 'TestAreaCoconut::PageDesign.Partials.Head');
            }

            if (in_array("header", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('header', 'TestAreaCoconut::PageDesign.Partials.Header.Header');
            }

            if (in_array("page_design", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('page-design', 'TestAreaCoconut::PageDesign.PageDesign');
            }

            if (in_array("footer", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('footer', 'TestAreaCoconut::PageDesign.Partials.Footer');
            }
        ...
        if (in_array("homepage", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Homepage.Homepage');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_view", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Category.Item.CategoryItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("basket", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Basket.Basket');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Checkout.CheckoutView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Customer.Login');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Customer.Register');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Item.SingleItemWrapper');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("search", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::ItemList.ItemListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::MyAccount.MyAccountView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("wish_list", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::WishList.WishListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("contact", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Customer.Contact');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::OrderReturn.OrderReturnView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::OrderReturn.OrderReturnConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_form", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.CancellationForm');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("newsletter_opt_out", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('TestAreaCoconut::Newsletter.NewsletterOptOut');
                return false;
            }, self::PRIORITY);
        }
        ...
        if(!empty($config->get("TestAreaCoconut.result_fields.override")))
        {
            $enabledResultFields = explode(", ", $config->get("TestAreaCoconut.result_fields.override"));
        }
        ...
        if(!empty($enabledResultFields))
        {
            $dispatcher->listen( 'IO.ResultFields.*', function(ResultFieldTemplate $templateContainer) use ($enabledResultFields)
            {
                ...
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_LIST_ITEM] = 'TestAreaCoconut::ResultFields.ListItem';
                }

                // Override single item view result fields
                if (in_array("single_item", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_SINGLE_ITEM] = 'TestAreaCoconut::ResultFields.SingleItem';
                }

                // Override basket item result fields
                if (in_array("basket_item", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_BASKET_ITEM] = 'TestAreaCoconut::ResultFields.BasketItem';
                }
                ...
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_AUTOCOMPLETE_ITEM_LIST] = 'TestAreaCoconut::ResultFields.AutoCompleteListItem';
                }

                // Override category tree result fields
                if (in_array("category_tree", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_CATEGORY_TREE] = 'TestAreaCoconut::ResultFields.CategoryTree';
                }
